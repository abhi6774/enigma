...
and Panchayat Samitis Act, 1961 is to introduce local selfgovernance and administration at the grassroots, and to entrust
790
...
Zilla Parishads with the execution of works and developmental
...
inherently beneficial to the elected representatives. [Para 16][799E-F]
...
that the funds flowed from the State Government to the Zilla
...
21][800-G; 801-A-B]
1.5. Probity in such financial transactions should be the rule
...
record to show even a separation of residence between the son
...
[Para 22][801-C-D]
1.6. That sufficient opportunities were made available to
...
Divisional Commissioner thus rightly treated the appellant’s
...
Collector, Raigad & Ors. (2012) 4 SCC 407 : [2012] 3
...
Sudhanshu S. Choudhari, Ms. Amarjitsingh Girase, Mahesh P.
...
Tyagi, Sravan Kumar Karanam, Advs. for the Respondents.
...
1. The appellant was elected as a member of the Zilla Parishad,
...
financial benefit. This financial benefit is stated to have accrued on account
...
successful in the tender process against two other applicants. Thereafter,
...
The application was filed under Section 16(1)(i) read with Section 40 of
the said Act. For reference, the provisions are reproduced hereunder:

E

“16. Disqualifications - (1) Subject to the provisions of subsection (2), a person shall be disqualified for being chosen as, and
...
if he has directly or indirectly by himself or by his partner
...
section is raised either by the Commissioner suo motu or on an
...
that the vacancy has occurred, the Councillor shall not be disabled
...
application in terms of the order dated 08.11.2021 in Disqualification
...
that there was no evidence of the appellant’s son having been awarded
...
argument, as the matter had already been adjourned on multiple occasions
...
The Act would not be applicable to the case as the road
...
Even assuming the applicability of the said Act, the language
...
The appellant had no ‘interest’ in his son’s financial affairs
as the latter had an independent business and the two of
them did not even reside together;

(d)

The order of disqualification violated the principles of natural
justice as the appellant was not given an opportunity of being
heard by the Divisional Commissioner.
...
7. The aforesaid pleas were however rejected by the High Court
as per the impugned judgment dated 17.11.2021. The conclusion was
based on the following findings:
A.

Section (16)(1)(i) of the said Act was broadly worded. It
...
repair work vide order dated 09.06.2020 under the
...
the agency that had disbursed the funds.

B.

The Divisional Commissioner had reached a plausible
...
however was not conclusive proof about the son’s financial
...
An opportunity of hearing was not required to be given to
the appellant as all the relevant facts were before the
...
mere formality and not have any bearing on the final
...
VIRENDRASING v. THE ADDITIONAL COMMISSIONER AND
ORS. [SANJAY KISHAN KAUL, J.]
account of advocate’s illness, although the appellant himself
...
8. The appellant’s primary plea was that his son was allocated
...
20.07.2020 was also under the seal of the Gram Panchayat, in view of
...
100, 100(2) and 125 of the said Act. The Zilla Parishad is stated not to
...
interest in his son’s business and that they did not even reside together.
...
alleged misconduct, as held by this Court in Ravi Yashwant Bhoir v.
...
Respondent No.3’s Resistance to the Claim of the Appellant:
...
worded with a wide ambit so as to encapsulate three categories, i.e.,
...
well. Thus it was urged that the facts fell squarely within the ambit of
...
awarded to the appellant’s son was really in the nature of a proxy benefit.
...
incurred for supervision and repairs of the said work, such resolution
...
State Government. This was also the stand taken by the Zilla Parishad
...
Court had distinguished Gulam Yasin’s case5 on the premise that it did
...
schemes of the State Government. It is in this conspectus that the said
...
disqualified on flimsy grounds. However, we are equally bound by the
...
Act. Thus, the use of the terminology – ‘directly or indirectly’, ‘by himself
...
be included, with the object of discouraging the practice of financial
...
invite disqualification, any interest or share had to be in the contract
...
18. In our opinion, both of these cases stand on a different footing
...
entered into a contract with the said Panchayat for the collection of
...
purity of administration in Municipal Committees.
...
He had no other contracts in that area or otherwise. The only contract
...
he had just completed his studies. In our view, this fact raises further
...
and the Zilla Parishad’s counter affidavit, reveal that the funds flowed
...
be the rule rather than the exception. The appellant had a greater
...
other than a ration card purporting to show that the son was living with
...
25. The appeal is accordingly dismissed leaving the parties to bear
their own costs.
Nidhi Jain
...
print(remove_single_char_lines(paragraphs).replace("\n", " "), file= file)
file.close()